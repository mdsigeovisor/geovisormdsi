...
*   **Módulo de Impresión (PDF):**
    ...
    *   **Fotografía del lote implementada:** nuevo pipeline que recolecta todos los `<img>` candidatos de `informacion.asp`, sigue el enlace "Ver Fotos" cuando existe, normaliza las rutas al proxy y descarga cada imagen como blob → DataURL (evita CORS y canvas contaminado); filtra iconos (<60 px), prioriza foto/frontis/fachada e incluye diagnóstico en consola.
