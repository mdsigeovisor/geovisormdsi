...
export const INITIAL_WMS_LAYERS: WmsLayerConfig[] = [
  ...
  { id: 'arbolado_urbano_2015', layerName: `${workspacePrefix}vw_arboles_2015`, zIndex: 3, title: 'Arboldes 2015'},
  { id: 'cactus_yucca_2015', layerName: `${workspacePrefix}vw_arboles_2015_cactus`, zIndex: 3, title: 'Cactus - Yucca 2015'},
  //* Capas Catastrales
